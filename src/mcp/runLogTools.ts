    ...
    "manciple_run_log",
    {
      ...
      inputSchema: {
        ...
        agent: z
          .string()
          .optional()
          .describe("The agent harness or tool used (e.g. 'Claude Code', 'Cursor')."),
        model: z
          .string()
          .optional()
          .describe("The model that performed the work (e.g. 'claude-sonnet-4-5')."),
        files_changed: z
          .array(z.string())
          .optional()
          .describe("List of file paths modified during the run."),
        commands_run: z
          .array(z.string())
          .optional()
          .describe("List of non-test shell commands executed during the run."),
        tests_run: z
          .array(z.string())
          .optional()
          .describe("List of test commands or test receipts executed during the run."),
        task_status: z
          .enum(STATUSES)
          .optional()
          .describe("Final task status to record in the run log."),
        ...
        decisions_made: z
          ...
          .optional()
          .describe(
            "Key decisions made during completed implementation work; omit only if blocked before meaningful changes.",
          ),
        follow_ups: z
          .array(z.string())
          .optional()
          .describe("Follow-up tasks or notes from the run."),
        verify_receipt: z
          .string()
          .optional()
        ...
        workspace: z
          .string()
          .optional()
          .describe("Registered managed worktree used for git evidence auto-capture."),
      },
    },
    ({
      repo,
